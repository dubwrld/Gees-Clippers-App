...
(async () => {
    ...
    let form = document.getElementById('new-event-form') as HTMLFormElement;
    let imgInput = document.getElementById('imageUpload') as HTMLInputElement;
    let descriptionInput = document.getElementById('index-create-events-listing-description') as HTMLInputElement;
    let titleInput = document.getElementById('index-create-events-listing-title') as HTMLInputElement;
    let accountCreationForm = document.getElementById("account-creation-form") as HTMLFormElement;
